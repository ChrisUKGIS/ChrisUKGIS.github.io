...
print ("Rand Industries: Agents, Loops and Distance")
...
for i in range(num_of_agents):
    ...
    agents.append(agentframeworkIO2.Agent(environment,agents))
...
for i in range(num_of_agents):
    print ("Agent "+str(i)+ ":- End Coords Y:" + str(agents[i].y) + " X:" + str(agents[i].x))
...
#        distance = agents[i].distance_between(t)       
